--
-- Synopsys
-- Vhdl wrapper for top level design, written on Thu Mar 25 22:39:18 2021
--
library ieee;
...
entity wrapper_for_topshiftbarrelrotationLR00 is
   port (
      clk0 : in std_logic;
...
end wrapper_for_topshiftbarrelrotationLR00;

architecture topshiftbarrelrotationlr0 of wrapper_for_topshiftbarrelrotationLR00 is

component topshiftbarrelrotationLR00
 port (
...
u1:   topshiftbarrelrotationLR00 port map (
		clk0 => tmp_clk0,
		cdiv0 => tmp_cdiv0,
		en0 => tmp_en0,
		in0 => tmp_in0,
