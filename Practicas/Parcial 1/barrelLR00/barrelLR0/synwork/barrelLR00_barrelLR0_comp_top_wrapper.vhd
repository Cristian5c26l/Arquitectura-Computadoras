--
-- Synopsys
-- Vhdl wrapper for top level design, written on Thu Mar 25 21:43:06 2021
--
library ieee;
...
entity wrapper_for_topshiftbarrelLR00 is
   port (
      clk0 : in std_logic;
...
end wrapper_for_topshiftbarrelLR00;

architecture topshiftbarrellr0 of wrapper_for_topshiftbarrelLR00 is

component topshiftbarrelLR00
 port (
...
u1:   topshiftbarrelLR00 port map (
		clk0 => tmp_clk0,
		cdiv0 => tmp_cdiv0,
		en0 => tmp_en0,
		in0 => tmp_in0,
